...
def _bn_relu(x, bn_name=None, relu_name=None):
    ...
    return Activation(curr_activation, name=relu_name)(norm)
    #return norm
...
def ResNet18(input_shape, classes, activation):
    """ResNet with 18 layers and v2 residual units
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[2, 2, 2, 2], activation=activation)


def ResNet34(input_shape, classes, activation):
    """ResNet with 34 layers and v2 residual units
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[3, 4, 6, 3], activation=activation)